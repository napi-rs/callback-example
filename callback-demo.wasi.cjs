// napi-rs-artifact-metadata:{"version":2,"rootEntry":"index.js","exports":["backgroundLogger","calculateSalary","downloadFileWithProgress","fetchUserProfile","monitorSystemResources","optionalCallbackTest","processEvents","processUserData","processWithFeedback","scheduleNotification","simpleCallbackTest","startFileWatcher","streamSensorData"],"managedRootEntries":["browser.js","index.js","callback-demo.wasm","callback-demo.debug.wasm"]}
/* eslint-disable */
/* prettier-ignore */
...
let __wasmFilePath = __nodePath.join(__dirname, 'callback-demo.wasm32-wasi.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'callback-demo.wasm32-wasi.debug.wasm')

if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  __wasmFilePath = __wasmDebugFilePath
} else if (!__nodeFs.existsSync(__wasmFilePath)) {
  const __wasiPackageEntry = require.resolve('@napi-rs/callback-demo-wasm32-wasi')
  const __packagedWasmFilePath = __nodePath.join(
    __nodePath.dirname(__wasiPackageEntry),
    'callback-demo.wasm32-wasi.wasm',
  )
  if (!__nodeFs.existsSync(__packagedWasmFilePath)) {
    throw new Error(
      '@napi-rs/callback-demo-wasm32-wasi is installed but is missing callback-demo.wasm32-wasi.wasm.',
    )
  }
...
module.exports.backgroundLogger = __napiModule.exports.backgroundLogger
module.exports.calculateSalary = __napiModule.exports.calculateSalary
module.exports.downloadFileWithProgress = __napiModule.exports.downloadFileWithProgress
module.exports.fetchUserProfile = __napiModule.exports.fetchUserProfile
module.exports.monitorSystemResources = __napiModule.exports.monitorSystemResources
module.exports.optionalCallbackTest = __napiModule.exports.optionalCallbackTest
module.exports.processEvents = __napiModule.exports.processEvents
module.exports.processUserData = __napiModule.exports.processUserData
module.exports.processWithFeedback = __napiModule.exports.processWithFeedback
module.exports.scheduleNotification = __napiModule.exports.scheduleNotification
module.exports.simpleCallbackTest = __napiModule.exports.simpleCallbackTest
module.exports.startFileWatcher = __napiModule.exports.startFileWatcher
module.exports.streamSensorData = __napiModule.exports.streamSensorData
